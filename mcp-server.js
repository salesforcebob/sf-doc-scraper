 ...
 * @returns {Promise<{title: string, markdown: string, pageType: string}>}
 */
...
server.setRequestHandler(ListToolsRequestSchema, async () => {
  return {
    tools: [
      {
        name: 'scrape_sf_docs',
        description: 'Scrape a Salesforce developer documentation page and return the content as markdown. Works with both guide pages (/guide/*) and reference pages (/references/*).',
        inputSchema: {
          type: 'object',
          properties: {
            url: {
              type: 'string',
              description: 'The full URL of the Salesforce documentation page to scrape (e.g., https://developer.salesforce.com/docs/einstein/genai/guide/get-started.html)',
            },
          },
          required: ['url'],
        },
